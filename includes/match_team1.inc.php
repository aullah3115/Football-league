    ...
    <select name="player">
      <option selected></option>
        ...
        /*
          ...
          WHERE PT.team_id=". $team1_id .";";
          $result = $conn->query($query);
*/
          $result = playerDetails($conn, $team1_id);
  ...
  <form method="post" action="scripts/deleteevent.s.php">
    ...
    $query = "SELECT ME.*, E.event_name, P.player_first, P.player_last FROM match_events AS ME
              ...
              WHERE ME.match_id=". $match_id ." AND PT.team_id =". $team1_id .";";
    $result = $conn->query($query);
    */
    $result = matchEvents($conn, $match_id, $team1_id);
